...
def write_samdat(transmission_data, filename):
    ...
    This function takes a DataFrame with appropriately named columns: "E", "exp_trans", and "exp_trans_unc". 
    These DataFrame keys correspond to the "trans" DataFrame generated by Syndat. This is an attribute of the experiment object once the experiment is "run".
    ...
    transmission_data : DataFrame
        DataFrame containing experimental transmission data.
    filename : str
